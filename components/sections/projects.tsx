          ...
          {resume.projects.map((p, i) => (
            <article
              ...
              className={`
                ...
                transition-all duration-1000 ease-[cubic-bezier(0.25,0.46,0.45,0.94)]
                hover:shadow-[0_0_30px_rgba(57,255,20,0.25)] hover:border-green-400/60 hover:scale-[1.02]
                ${visibleItems.has(i) 
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {p.tags.map((t) => (
                    <span
                      ...
                      transition-all duration-300 group-hover:border-green-400/40 group-hover:bg-green-400/10 group-hover:text-green-400"
                    >
                      {t}
                    </span>
                  ))}
